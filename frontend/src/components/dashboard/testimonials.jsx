        ...
        if (localStorage.getItem("access")) {
            ...
            try {
                const res = await axios.get(
                    `${process.env.REACT_APP_API_URL}/dashboard-testimonials`,
                    config
                );
                return res.data;
            } catch (err) {
        ...
        <section className="container">
            ...
            {isTestimonial ? null : (
                <Alert variant="info" className="fw-bold">
                    You can only add one Testimonial. Click on edit to make
                    necessary changes
                </Alert>
            )}

            <section
                className={`d-block btn btn-primary py-6 ${
                    isTestimonial ? null : "disabled"
                }`}
                onClick={() => handleAdd()}
            >
                                        ...
                                        <div class="row g-3 align-items-center">
                                            <div class="col-lg-4">
                                                ...
                                                <section class="text-center">
                                                    ...
                                                    <small class="card-title badge rounded-pill text-bg-primary ">
                                                        {item.designation}
                                                    </small>
                                                </section>
                                            </div>
